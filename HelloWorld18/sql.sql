...
insert into TBL_MENU values('상의', 'top')
insert into TBL_MENU values('하의', 'bottoms')
insert into TBL_MENU values('셔츠', 'shirt')

create table tbl_footerinfo (
	companyname varchar2(60),
	representative varchar2(60),
	bsns_reg_no number(24),
	cmnct_saler_report varchar2(60),
	address varchar2(150),
	partnership_email varchar2(150),
	phone_number number(24),
