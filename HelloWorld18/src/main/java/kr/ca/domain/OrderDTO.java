...
public class OrderDTO implements Serializable {
	...
	public OrderDTO(int ono, String name, String address, int total_price, String order_date, String shipping_memo,
			String payment_status, List<OrderDetailDTO> detailList) {
		super();
		this.ono = ono;
		this.name = name;
	...
	public String toString() {
		return "OrderDTO [ono=" + ono + ", name=" + name + ", address=" + address + ", total_price=" + total_price
