...
//	}
	...
	public String insert(CSDTO vo) {
		...
		/* String dirFront = "c:supload"; */
		/*
		 * // 디렉토리 System.out.println(vo.getQfile()); String dirName =
		 * vo.getQfile().substring(1, 13); // 파일명 String fileName =
		 * vo.getQfile().substring(15);
		 */
		
		/*
		 * //디렉토리 가공 String dir=dirFront+dirName+fileName;
