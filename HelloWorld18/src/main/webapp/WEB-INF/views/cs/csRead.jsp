      ...
      <div class="row">
		...
		<div class="form-group">
         ...
         <div class="form-group">
            ...
            <textarea class="form-control" readonly name="qcontent" id="qcontent">${vo.qcontent}</textarea>
         </div>
		...
		<div class="form-group">
         ...
         <div class="form-group">
            ...
            <button id="reply" class="btn btn-primary" onclick = "location.href = 'answerui?bno=${vo.bno}' ">답변</button>
         </div>
