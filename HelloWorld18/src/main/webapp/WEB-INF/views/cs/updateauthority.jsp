...
<br><br><br><br><br>
	...
	<div class="container" >
		<div class="row" >
			<form action="/cs/updateui" method="get" style="min-height: 350px; " >
				<div class="form-group">
					<label for="password">수정을 계속 진행하시려면 글 작성할 때 설정한 비밀번호를 입력하세요</label>
					<input id="password" class="form-control" name="password" style="">
				</div>
